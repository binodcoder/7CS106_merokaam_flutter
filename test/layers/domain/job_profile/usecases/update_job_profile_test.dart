...
void main() {
  ...
  test(
    ...
    () async {
      when(mockJobProfileRepository.updateJobProfile(tJobProfileModel)).thenAnswer((_) async => Right(tResponse));
      final result = await usecase(tJobProfileModel);
      expect(result, Right(tResponse));
      verify(mockJobProfileRepository.updateJobProfile(tJobProfileModel));
